...
<body>
    <form id="form1" runat="server">
        ...
        <div class="senter">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" DataKeyNames="emp_cd" DataSourceID="m_employee" GridLines="None" Width="1052px">
            <Columns>
        ...
        従業員コードを選択してください。<asp:DropDownList ID="Emp_Cd_List" runat="server" DataSourceID="SqlDataSource1" DataTextField="emp_cd" DataValueField="emp_cd" Height="35px" Width="109px">
        </asp:DropDownList>
            <br />
        ...
        <asp:Button ID="UpDateButton" runat="server" Text="更新" OnClick="UpDateButton_Click" style="width: 42px" />
