...
<body>
   <form id="form1" runat="server">
    ...
    <div>
        <table>
            <tr><td align="left">従業員コード：</td><td align="left"><asp:TextBox ID="TextBox1" runat="server"></asp:TextBox><br /></td></tr>
            <tr><td align="left">氏：</td><td align="left"><asp:TextBox ID="TextBox2" runat="server"></asp:TextBox><br /></td></tr>
            <tr><td align="left">氏(ふりがな) :</td><td align="left"><asp:TextBox ID="TextBox3" runat="server"></asp:TextBox><br /></td></tr>
            <tr><td align="left">名：</td><td align="left"><asp:TextBox ID="TextBox4" runat="server"></asp:TextBox><br /></td></tr>
